...
insert into citytown values (1,'White Plains'),(2,'Rye'),(3,'Scarsdale'),(4,'Sleepy Hollow'),(5,'Tarrytown');
...
values('odaly','iona','5 washington ave','ny','white plains',10606,45453456787,'1994-12-12');

CREATE TABLE `assign_driver` (
    `assign_driverID` int auto_increment NOT NULL ,
...
ALTER TABLE `Customer` ADD CONSTRAINT `fk_Customer_city` FOREIGN KEY(`city`)
